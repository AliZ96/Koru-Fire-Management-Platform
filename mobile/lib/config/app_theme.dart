...
class AppTheme {
  ...
  // Web-synced tokens
  static const Color webBg = Color(0xFF050E07);
  static const Color webAccent = Color(0xFFF59E0B);
  static const Color webText = Color(0xFFE2F0DA);
  static const Color webText2 = Color(0xFF7BA368);
  static const Color webBorder = Color(0x2E4A7C3A); // rgba(74,124,58,.18)
